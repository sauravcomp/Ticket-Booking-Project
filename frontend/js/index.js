...
document.getElementById('nav2').addEventListener('click',()=>{
     window.location.href = 'http://127.0.0.1:5500/frontend/book-ground.html'
})
document.getElementById('nav4').addEventListener('click',()=>{
     window.location.href = 'http://127.0.0.1:5500/frontend/user-profile.html'
})
document.getElementById('nav3').addEventListener('click',()=>{
     window.location.href = 'http://127.0.0.1:5500/frontend/cancle-booking.html'
})
